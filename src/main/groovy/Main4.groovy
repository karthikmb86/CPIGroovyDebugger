...
//def teacherClassification = 'AUS/30/13'


// Entry point
static void main(String[] args) {
    println "Hello world!"
    def classificationAllowed = 'AUS/60,AUS/20,AUS/30,AUS/36,AUS/37,AUS/38,AUS/59';
    def svp_timetype = '6023,6511'
    def filePath = '/Users/Wei/Downloads/230901.xml'
//    def filePath = 'C:/Users/Wei/Downloads/30044.xml'
    def xml = parseXML(filePath)
...
// Parse XML from file
def parseXML(String filePath) {
    new XmlParser().parse(new File(filePath))
}
