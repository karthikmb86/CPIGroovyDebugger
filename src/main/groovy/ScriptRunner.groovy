...
class ScriptRunner {
    ...
    static void main(String[] args) {
        ...
        //String scriptPath = (args?.length ?: 0) > 0 ? args[0] : "src/main/groovy/ProcessIncrement_Fix_8Sep25.groovy"
        //String scriptPath = (args?.length ?: 0) > 0 ? args[0] : "src/main/groovy/ProcessIncrement_Prod_Before8SepChange.groovy"
        String scriptPath = (args?.length ?: 0) > 0 ? args[0] : "src/main/groovy/ProcessIncrement_Fix_19Sep25_WithPartialFix_DecimalPointsIssue.groovy"
        String samplePath = (args?.length ?: 0) > 1 ? args[1] : "samples/240723_DecimalIssue_Prod.xml"
