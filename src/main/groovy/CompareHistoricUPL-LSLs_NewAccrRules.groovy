...
Message processData(Message message) {
    ...
    LocalDate lslEligibility = parseLocalDate(primaryEmp?.customDate4?.text())
...
messageLogFactory.getMessageLog(message)?.addAttachmentAsString(
    ...
    messageLogFactory.getMessageLog(message)?.addAttachmentAsString(
        ...
        "Key=${payScaleKey3}, L1=${bucket.L1}, L1Ovr=${bucket.L1Ovr}, L2Ovr=${bucket.L2Ovr}, acctType=${accountType}, LSL=${lslEligibility}",
        "text/plain"
    )
